//
//  DropboxMediaMetadataDictionaryParserTests.m
//  ObjectiveDropbox
//
...
@interface DropboxMediaMetadataDictionaryParserTests : XCTestCase

@property (nonatomic) DropboxMediaMetadata *meta;

@end

@implementation DropboxMediaMetadataDictionaryParserTests
...
- (void)testGoodDictionary {
    ...
    self.meta = [[DropboxMediaMetadata alloc] initWithDictionary:dic];
...
- (void)testBadDictionary
{
    ...
    XCTAssertNoThrow(self.meta = [[DropboxMediaMetadata alloc] initWithDictionary:dic]);
}
